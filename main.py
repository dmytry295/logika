...
def add_tag():
    ...
    if key in notes: #  чи замітк існує в списку
...
def change_theme():
    window.setStyleSheet(' background-color:blue;color:white;front-size:20px; border: 1px solid white;')
    text_editor.setStyleSheet('background-color:blue;color:white')

    list_widget_1.setStyleSheet('background-color:blue;color:white')
    list_widget_2.setStyleSheet('background-color:blac;color:white')
    text_editor.setStyleSheet('background-color:grey;color:white')

    text_searcher.setStyleSheet('background-color:brown;color:white')
    tag_searcher.setStyleSheet('background-color:black red;color:white')
    
    make_note.setStyleSheet('background-color:purple;color:white')
    delete_note.setStyleSheet('background-color:black blue;color:white')
    save_note.setStyleSheet('background-color:black yellow;color:white')

    search_for_text.setStyleSheet('background-color:green;color:white')
    search_for_tag.setStyleSheet('background-color:yellow;color:white')

    add_to_note.setStyleSheet('background-color:red;color:white')
    unpin_to_note.setStyleSheet('background-color:pink;color:white')
    convert_to_txt.setStyleSheet('background-color:cyan;color:white')

    action_theme_btn.setStyleSheet('background-color:orange;color:white')
